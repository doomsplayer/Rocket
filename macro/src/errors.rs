error_chain! {
  ...
  errors {
    ...
    RouteUnknownParam(params: Vec<String>) {
      description("route got unknown param")
      display("unknown params for route: '{:?}'", params)
    }
    FnParamContainSelf {
      description("fn contains self param")
      display("fn can not have self parameter")
    }
    FnArgHasNoName {
    ...
    ErrorParamNumNotCorrect {
      description("error param number not correct")
